...
const Loading: React.FC = () => {
    return (
        <div role="status" className="flex flex-col w-screen h-screen justify-center items-center">
            <div className="text-slate-400 text-center mb-4">
                <div className="text-2xl mb-2">Open Source Summary</div>
                <div className="text-lg">&copy; Afaan Bilal</div>
            </div>
